...
namespace QLLopHoc.GUI.KhoaHoc
{
    public partial class ThemChuongfrm : Form
    {
        ...
        public ThemChuongfrm(ChuongDTO chuong, KhoaHocfrm khfrm)
        {
            InitializeComponent();
            this.chuong = chuong;
            this.khfrm = khfrm;
        ...
        private void btnTaoChuong_Click(object sender, EventArgs e)
        {
            ...
            ChuongDTO chuong = new ChuongDTO(Guid.NewGuid().ToString(), txtTenChuong.Text, DateTime.Now, khfrm.Lophoc.Malop, 0);
